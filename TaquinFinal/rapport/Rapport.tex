...
%\usepackage{hyperref}
% Quelques rÃÂÃÂ©glages particuliers
...
\caption{#2} %la lÃÂÃÂ©gende
\label{#3} %l'ÃÂÃÂ©tiquette pour faire rÃÂÃÂ©fÃÂÃÂ©rence ÃÂÃÂ  cette image
\end{center}
...
%\hyphenation{supplÃÂÃÂ©mentaires}{sup-pl\'e-men-tai-res}
%opening
